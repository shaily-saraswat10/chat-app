...
const ProfilePage = () => {
  ...
  const handleSubmit= async (e)=>{
    ...
    //FileReader.readAsDataURL(file) → converts image file to base64 format.
    const reader = new FileReader()
     reader.readAsDataURL(selectedImg);
    
     //base64Image ->  contains the base64 string.
     ////reader.onload → callback that fires when the conversion finishes.
    reader.onload = async ()=>{ 
